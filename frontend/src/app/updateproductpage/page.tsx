...
const UpdateProduct = () => {
  ...
  const productId = searchParams.get('id'); // Get the id from the query parameters
  ...
  const handleSubmit = async (e: { preventDefault: () => void; }) => {
    ...
    try {
      ...
      const response = await AxiosInstance.patch(`/ecommerce/product/?id=${productId}`, formData, {
        headers: {
