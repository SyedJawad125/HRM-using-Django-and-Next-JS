        ...
        {filteredRecords.length > 0 ? (
          <div>
            ...
            <div className="grid grid-cols-6 text-white font-bold bg-gray-900 p-2 rounded-t-lg">
              ...
              <span className="text-left -ml-60">Detp Name</span>
              <span className="text-left -ml-52">Location</span>
              <span className="text-left -ml-64">Description</span>
            ...
            <ul className="list-none">
              {filteredRecords.map((item, index) => (
                <li key={item.id} className="grid grid-cols-6 bg-gray-800 text-white p-0 border-t border-gray-700 mt-4">
                  ...
                  <span className="text-left -ml-60 mt-4">{item.dept_name}</span>
                  <span className="text-left -ml-52 mt-4">{item.dept_location}</span>
                  <span className="text-left -ml-64 mt-4">{item.dept_description}</span>
                  <span className="text-left -ml-48 mt-4">{item.dept_budget}</span>
